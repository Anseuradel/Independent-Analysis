...
COMPETITIONS = [
    "global-country-information-eda",
    "superstore-sales-eda-ml",
    "japanese-universities-eda",
    "eda-predictive-analysis-most-popular-movies",
    "ml-eda-apple-quality",# replace with your target competitions
]

TOP_K = 3
BASE_DIR = "Independent-Analysis"
